...
class CityAdapter(val callBack: CountryCallBack,context: Context, private val data: List<City>) :
    ArrayAdapter<City>(context, 0, data) {
    ...
    interface CountryCallBack{
        fun getCountryCall(position: Int,list:kotlin.collections.List<City>)
    }
}