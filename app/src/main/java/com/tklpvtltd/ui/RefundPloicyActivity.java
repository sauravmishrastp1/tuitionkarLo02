...
public class RefundPloicyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refund_ploicy);
    ...
    private void getcontent() {
        webUrl = "https://tklpvtltd.com/refund-policy";
    ...
    private void loadWebViewLoad(final WebView webview) {
        ...
        final ProgressDialog pd = ProgressDialog.show(RefundPloicyActivity.this, "", "Please wait...", true);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(getApplicationContext(), RefundPloicyActivity.class);
        startActivity(intent);
    }
}